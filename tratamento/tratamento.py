...
def obter_limite_municipio_cachoeiro_de_itapemirim():
    ...
    gdf_municipio_cachoeiro_de_itapemirim = gdf_municipios[gdf_municipios['nome'] == 'Cachoeiro de Itapemirim']

    # salvar
    gdf_municipio_cachoeiro_de_itapemirim.to_file(os.path.join("dados", "dados_tratados", "limite_municipio_cachoeiro_de_itapemirim.geojson"), driver='GeoJSON')
...
def obter_hexagonos_cachoeiro_de_itapemirim():
    # Definir o caminho relativo
    caminho_municipios = os.path.join("dados", "dados_tratados", "limite_municipio_cachoeiro_de_itapemirim.geojson")
    ...
    intersected = gpd.overlay(population, municipio_cachoeiro_de_itapemirim, how='intersection')
...
def obter_unidades_saude_cachoeiro_de_itapemirim():
    ...
    # salva o arquivo
    gdf_unidades_saude_cachoeiro_de_itapemirim.to_file(os.path.join("dados", "dados_tratados", "unidades_saude_cachoeiro_de_itapemirim.geojson"), driver='GeoJSON')
